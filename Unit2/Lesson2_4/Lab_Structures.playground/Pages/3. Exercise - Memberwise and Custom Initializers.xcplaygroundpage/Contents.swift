...
var favoriteBook = Book(title: "Song of Solomon", author: "Toni Morrison", pages: 337, price: 9.99)
print("My favorite book is \"\(favoriteBook.title)\" by \(favoriteBook.author). It has \(favoriteBook.pages) pages and costs about $\(favoriteBook.price).")
/*:
...
var firstLaptop = Laptop(yearPurchased: 2019)
var secondLaptop = Laptop(screenSize: 16, yearPurchased: 2021)
/*:
