...
var celeste = User(name: "Celeste", age: 26, height: 61, weight: 170, activityLevel: 5)
print("The user's name is \(celeste.name), and she is \(celeste.age) years old. She's \(celeste.height) inches tall and weighs \(celeste.weight) pounds. Her current activity level is \(celeste.activityLevel).")
/*:
...
var secondDistance = Distance(meters: 50)
print(secondDistance.feet, secondDistance.meters)
/*:
