...
struct User {
    ...
    static var currentUser = User(userName: "celeste", email: "celeste@me.com", age: 29)
    
    static func logIn(user: User) {
        self.currentUser = user
        print("\(currentUser.userName) has been logged in.")
    }
}
 ...
 */
var newUser = User(userName: "myUsername", email: "good@email.com", age: 83)
