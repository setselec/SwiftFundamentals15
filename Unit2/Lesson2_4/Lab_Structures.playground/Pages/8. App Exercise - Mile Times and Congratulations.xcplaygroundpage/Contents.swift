...
struct RunningWorkout {
    ...
    var averageMileTime: Double {
        var distanceInMiles = distance / 1600
        return time / distanceInMiles
    }
}
var myBestWorkout = RunningWorkout(distance: 900, time: 345, elevation: 500)
print(myBestWorkout.averageMileTime)
/*:
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congratulations! You've reached your \(goal) step goal!")
            }
        }
    }
    var goal: Int
...
var yourSteps = Steps(steps: 9999, goal: 10000)
yourSteps.takeStep()
/*:
