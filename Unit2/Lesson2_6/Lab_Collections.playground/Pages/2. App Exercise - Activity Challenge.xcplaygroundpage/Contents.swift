 ...
 */
var walkingChallenges: [String] = ["Walk for an hour", "Walk with a friend", "Walk 5 miles"]
var runningChallenges: [String] = ["Run a mile twice a week", "Run a marathon", "Beat your previous mile time"]
...
if userChallenges.isEmpty {
    print("Try finding a challenge to commit to!")
