...
let heartRate1D: Double = 81
let heartRate2D: Double = 65
let heartRate3D: Double = 93
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print("Average heart rate:",averageHRD)
print("This average was not an integer because the type for each heart rate value was specified as 'Double'.")
