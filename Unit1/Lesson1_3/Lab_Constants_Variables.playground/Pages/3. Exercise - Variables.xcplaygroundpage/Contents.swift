...
print("The code compiles this time because number is assigned to a variable, which is mutable. The constant didn't compile because they can't be reassigned a new value.")
